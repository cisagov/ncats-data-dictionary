...
issue](https://github.com/cisagov/ncats-data-dictionary/issues) in this
...
request](https://github.com/cisagov/ncats-data-dictionary/pulls), you will
...
```console
cd ncats-data-dictionary
pyenv virtualenv <python_version_to_use> ncats-data-dictionary
pyenv local ncats-data-dictionary
